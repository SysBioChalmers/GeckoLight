%This function is just copied from ecModels and renamed for convenience, it has not been changed
function [model,name,version] = preprocessModelLt(model,name,version)
%preprocessModel
%
