%This function was copied and renamed - it is slow, but in some places it is still used
function [uni,EC,MW,Genes,conflicts] = findInDBLegacy(grRule,DBprot,DBgenes,DBecNum,DBMW)
% findInDB
